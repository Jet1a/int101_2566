...
public class Int101Homework01 {
    ...
    static void work03UseOfUtilityClass() {
      ...
      */
        ...
        System.out.println("CalculateBMI: " + myUtil.calculateBMI(45.1, 1.6));
        System.out.println("Average: " + myUtil.average(47, 42, 69));
    }
    ...
    static void work04UseOfObjectClass() {
      ...
      */
        ...
        System.out.println("Deposit: 5000.00$");
        ...
        System.out.println("Transfer 456 > 777 Amount:1000.00$");
